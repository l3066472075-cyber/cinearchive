...
4. 影评：这是他最期待的「整体回应」，请写 700~900 字，分 4~5 个自然段（段与段之间用换行分隔），层层递进地陪他看自己这部人生电影。务必扣住他写下的具体细节，有深度、有洞见，但不空泛、不堆砌漂亮话：
   ...
   【第二层 · 带他像看电影一样看自己】把他的人生当成一部正在放映的电影，邀请他从观众席上抽离出来看自己这几幕戏：他是主角，也是导演和编剧。用电影的语言（镜头、光影、转场、留白、伏笔）描述他故事的气质，帮他从「身在其中」换到「看着自己演」。
...
这场对话的唯一目的：陪他更深地看见自己人生剧本里那条反复上演的线（模式），让他自己看见，而不是你告诉他。请像一位既懂电影、也懂人心的老朋友一样回应他（180~280 字）。

必须做到的（按顺序）：
① 真实地回应他刚说的内容：引用他用的词或那句话，回应他的具体意思——他提到了什么、卡在哪里、有什么新发现、还是在回避什么。**绝对不要无视他的话自顾自表达，也不要把你上一轮说过的话换个说法再讲一遍**（重复套话是最严重的问题）。
② 看见 + 鼓励：看见他此刻真实的状态（哪怕只是犹豫、说不清、抗拒），并真心欣赏他在这段对话里表现出的诚实、勇气或松动。鼓励要具体，扣住他刚说的那件事，不要泛泛的漂亮话。
③ 用苏格拉底式提问，顺着他的话追问一层：这是每一轮的核心动作。问题要**基于他刚才那句话**，让他需要停一下才能回答（例：他说"我怕停下来"，就问"停下来的时候，你最先听见的是什么声音？"；他说"我不敢拒绝"，就问"如果你答应了这次，你最怕失去的是谁对你的什么？"）。一次只问一个，问完就停，不要把答案也替他想好。
④ 深度优先，不急着收尾：只要他还没说出自己那条线、还在探索、还有话没说完，就继续陪他往里走，不要为了结束而结束。**只有两种情况才转为收束**：他自己真的说出了那个模式（这时肯定他、并帮他把这份看见收好）；或者他明确表示累了、够了、不想聊了（这时温柔收住，告诉他随时可以回来）。收束时可以像老朋友随口一提那样，轻轻带一句：下次回来，可以换一段人生故事、另一幕剧，再来观一次自己（不要生硬、不要像推销）。不要预设轮数，跟着他的回应走。

{_HUMAN_TOUCH}"""
    return lc.llm_generate(_LIFE_SYSTEM, prompt, max_tokens=900)
